...
$result =mysqli_query($conn,$sql);
   ...
   ?> 
     <div class="col-md-4 form">
                ...
                <div class="my-4">PHONE NUMBER: <?php echo $_SESSION["phnumber"]?></div>
                <div>EMAIL: <?php echo $_SESSION["email"]?></div>
                <div class="my-4">ADDRESS: <?php echo $_SESSION["useraddress"]?></div>
...
<form name='razorpayform' action="verify.php" method="POST">
   ...
   $orderData = [
       'receipt'         => 'rcptid_11',
       'amount'          => ($totalprice * 100), // 39900 rupees in paise
       'currency'        => 'INR'
   ];
