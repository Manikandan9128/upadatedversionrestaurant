...
<div class="container">
    <div class="row my-5">
        <div class="col">
            ...
            <form action=" " class="d-flex justify-content-center flex-column my-5" enctype="multipart/form-data" method="post">
            <div class="col-auto my-4">
                ...
                <input type="submit" class="btn btn-primary px-5 py-3" name="adminadd" value="submit">
                </div>
            </form>
        </div>
    </div>
