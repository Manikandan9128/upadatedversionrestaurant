...
<a href='<?php echo "adminaddfood.php?userid=$userid";?>' class="btn btn-success">ADD FOOD ITEMS</a>

    <div class="row">
        <div class="col-8 shadow my-5 ">
        <a  href="shopdetails.php"class="ms-auto"><i class="fas fa-edit"></i></a>
        ...
        <table class="table shadow px-5">
            ...
            <?php
                ...
                <tr>
                    ...
                    <td><a href='<?php echo "updateadminfood.php?foodid=$foodid" ?>' class="btn btn-primary">EDIT</a></td>
                    <?php
                    if($foodstatus==0){
                  ...
                  <td><a href="<?php echo "deletecart.php?deleteadminfoodid=$foodid"?>" class="btn btn-danger">DELETE</a></td>
                </tr>
                <?php
                    }}
                    else{
                        echo "<div>Items not found</div>";
                        echo "<a href='restaurant.php' class='btn btn-secondary'>BACK</a>";
                    }
                    ?>
            </tbody>
        </table>
